...
public:
  ...
  void setParams(void* str, const void* inc, void* val, const byte valType) {
    _str = str;
    _valType = valType;
    _inc = inc;
    _val = val;
...
public:
  ...
  void addItem(void * str) {
    doAddItem(str, VAL_ACTION, nullptr, nullptr, nullptr, nullptr);
  }

  void addItem(void * str, int* inc, int* val, int* min, int* max, int* dp) {
    doAddItem(str, VAL_INTEGER, inc, val, min, max);
  }

  void addItem(void * str, const unsigned int* inc, unsigned int* val, const unsigned int* min, const unsigned int* max) {
    doAddItem(str, VAL_U_INTEGER, inc, val, min, max);
  }

  void addItem(void * str, const double* inc, double* val, const double* min, const double* max) {
    doAddItem(str, VAL_DOUBLE, inc, val, min, max);
  }

  void addItem(void * str, const float* inc, float* val, const float* min, const float* max) {
    doAddItem(str, VAL_FLOAT, inc, val, min, max);
  }

  void addItem(void * str, const byte* inc, byte* val, const byte* min, const byte* max) {
...
private:
  ...
  void doAddItem(void* str, byte valType, const void* inc, void* val, const void* min, const void* max) {
