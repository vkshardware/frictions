...
//=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-==-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
#define nCS (1 << PC6)  //chip select line MCP2515
...
* input: const unsigned char address 0x01
* output: unsigned char
*******************************************************************/
...
void mcp2515_setRegisterS(const unsigned char address,
